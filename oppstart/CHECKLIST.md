...
| Supabase (Next.js) | `https://supabase.com/docs/guides/getting-started/quickstarts/nextjs` | 06, 07 |
| Supabase Auth SSR | `https://supabase.com/docs/guides/auth/server-side/nextjs` | 06 |
| Supabase CLI | `https://supabase.com/docs/guides/cli` | 06 (migrations) |
...
- [ ] [06 — Supabase](./06-install-supabase.md) — prosjekt-gjennomgang, klienter, auth-sider, RLS, (valgfritt) CLI + migrations
