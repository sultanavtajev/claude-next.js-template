...
|-------|-----|-------------------|
| Next.js | `https://nextjs.org/docs` | 02, 10 (build) |
| GitHub CLI | `https://cli.github.com/manual/` | 12 |
| Vercel CLI | `https://vercel.com/docs/cli` | 13 |
...
| Supabase (Next.js) | `https://supabase.com/docs/guides/getting-started/quickstarts/nextjs` | 07, 09 |
...
| Resend MCP | `https://resend.com/docs/mcp-server` | 08 |
| Vercel | `https://vercel.com/docs/frameworks/nextjs` | 13 |
| T3 Env | `https://env.t3.gg/docs/nextjs` | 09 |
...
- [ ] [08 — Resend](./08-install-resend.md) — **(valgfri)** konto-opprettelse, API-nøkkel, domain-verify, e-post-klient, MCP-autorisering
...
- Noen steg er **valgfri** i sin helhet (steg 08 Resend, steg 13 Vercel) eller har valgfri deler (f.eks. Del 4 i steg 07). Valgfrie deler krever ikke avkrysning for at steget regnes som ferdig — men dokumentér i rapport hvis du hopper over dem.
...
- Etter steg 14 er alt ferdig — ikke gjør noe ekstra.
