# Steg 10 — Remote-oppsett (Git, GitHub, Vercel)
...
Kryss av hver `[ ]` → `[x]` fortløpende. Når Del 1 + Del 2 er `[x]` (Del 3 er valgfri), marker steg 10 i `oppstart/CHECKLIST.md` og gå til steg 11.
...
Se `## Sjekkliste` øverst i denne filen. Når Del 1 + Del 2 er fullført (Del 3 Vercel er valgfri), kryss av steg 10 i `oppstart/CHECKLIST.md`.
