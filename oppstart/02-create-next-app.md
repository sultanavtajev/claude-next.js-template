...
`--skip-git` hindrer create-next-app fra å initialisere git (steg 10 gjør det):
...
- **create-next-app opprettet `.git/` likevel**: `--skip-git` var ikke med. Kjør `rm -rf .git` — steg 10 oppretter git-repo på riktig måte senere.
