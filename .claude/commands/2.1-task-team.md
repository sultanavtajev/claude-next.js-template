...
- Alle teammates som lager UI skal kalle `/4.0-ui <beskrivelse>` — den garanterer både `design-system-retrieval` og `ui-ux-pro-max` aktiveres.
- For mindre styling-endringer: `design-system-retrieval` aktiveres automatisk og leser MASTER.
