...
- Alle teammates som lager UI skal kalle `/4.0-ui <beskrivelse>` — den garanterer at MASTER leses og `ui-ux-pro-max` kalles.
- For mindre styling-endringer: regelen i CLAUDE.md "Skill-precedence ved UI-arbeid" gjelder fortsatt.
