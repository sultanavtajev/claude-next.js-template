...
- For all UI-arbeid: bruk `/4.0-ui <beskrivelse>` — den garanterer at MASTER leses og `ui-ux-pro-max` kalles før kode genereres.
- For større UI-deler innenfor denne oppgaven: kall `/4.0-ui` per del med klar beskrivelse.
- For små styling-endringer hvor `/4.0-ui` ikke kalles: regelen i CLAUDE.md "Skill-precedence ved UI-arbeid" gjelder fortsatt — les MASTER, konsulter ui-ux-pro-max.
